...
describe('ProductReviewService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [ProductReviewService, ErrorHandlingServiceService, MessageService],
    });
  ...
  it('should get all product reviews', () => {
    ...
    service.getAllProductReview().subscribe((response) => {
  ...
  it('should retrieve product reviews by Id', () => {
    ...
    service.getProductReviewByProductID(productId).subscribe((response) => {
